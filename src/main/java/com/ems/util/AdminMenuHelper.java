...
public class AdminMenuHelper {
    ...
    /**
     * Prints system-generated logs, starting the display index at 1.
     *
     * @param logs list of system logs
     */
    public static void printSystemLogs(List<SystemLog> logs) {
        printSystemLogs(logs, 1);
    }

    /**
     * Prints system-generated logs with a caller-supplied start index.
     *
     * @param logs       list of system logs
     * @param startIndex 1-based index of the first item in this page
     */
    public static void printSystemLogs(List<SystemLog> logs, int startIndex) {
        ...
        System.out.println("\nSYSTEM LOGS");
        System.out.println(SEPARATOR);
        System.out.printf("%-5s %-20s %-10s %-22s %-15s %-40s%n",
                "NO", "TIME", "USER", "ACTION", "ENTITY", "MESSAGE");
        System.out.println(SUB_SEPARATOR);

        int index = startIndex;
        for (SystemLog log : logs) {
            System.out.printf("%-5d %-20s %-10s %-22s %-15s %-40s%n",
                    index++,
