...
public class EventSearchAction {
    ...
    public void handleSearchByDate() {
        try {
            String input = InputValidationUtil.readNonEmptyString(ScannerUtil.getScanner(),
    ...
    public void handleSearchByDateRange() {
        try {
            String startInput = InputValidationUtil.readNonEmptyString(ScannerUtil.getScanner(),
            ...
            String endInput = InputValidationUtil.readNonEmptyString(ScannerUtil.getScanner(),
